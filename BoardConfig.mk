...
# Assert
TARGET_OTA_ASSERT_DEVICE := a2corelte

# Bootloader
TARGET_BOOTLOADER_BOARD_NAME := SRPSB19D014RU

# File systems
BOARD_HAS_LARGE_FILESYSTEM := true
#BOARD_RECOVERYIMAGE_PARTITION_SIZE := 22358560 # This is the maximum known partition size, but it can be higher, so we just omit it
